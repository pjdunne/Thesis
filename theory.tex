...
As described in \SectionRef{sec:ssb} all known particles with mass couple to the Higgs boson. It might therefore be expected that \ac{DM}, which we know is massive, also couples to the Higgs boson.
