...
%??figs 12 and 15 from pas hig-15-002

This limit leaves significant parameter space open for \ac{BSM} Higgs boson decays. Furthermore, as the above limit assumes the \ac{SM} Higgs boson total width, it is possible that the branching ratio to invisible final states is much larger, making the case for direct measurements even more compelling.
