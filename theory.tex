...
\begin{figure}
  ...
  \caption{Feynman diagrams for the four \ac{SM} Higgs boson production processes with the highest cross-sections: \ac{ggH} (a), \ac{VBF} (b), VH (c) and top quark associated production (d).}
