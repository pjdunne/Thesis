...
thesis.pdf: thesis.tex thesis.cls theory.tex detector.tex obj.tex prompt.tex parked.tex comb.tex interp.tex conclusions.tex frontmatter.tex appparkedtrigeff.tex backmatter.tex
	@rm -f $(EXTRASTYS)
