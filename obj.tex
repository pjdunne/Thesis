...
Finally, jets which are within 0.5 in the $\eta-\phi$ plane of any veto electron, defined in \SectionRef{sec:electrons} or loose muon, defined in \SectionRef{sec:muons} are vetoed, to avoid using jets which are due to misreconstructed leptons.
