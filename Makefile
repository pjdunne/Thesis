...
thesis.pdf: thesis.tex thesis.cls theory.tex detector.tex obj.tex stats.tex prompt.tex parked.tex comb.tex run2.tex frontmatter.tex appendices.tex backmatter.tex
	@rm -f $(EXTRASTYS)
