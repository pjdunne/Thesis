...
\label{sec:promptzextrap}
%??pileup weights, cross-sections, pdf uncertainty, qcd scale, luminosity, electron contamination in tau region, mc stat


\begin{table}
  \caption{A summary of the uncertainties in the total expected signal and background yields. All uncertainties are quoted as teh change in the yield when each effect is varied up and down according to its uncertainty. The signal yields assume a Higgs boson mass of 125\GeV.}
